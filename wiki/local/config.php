...
$WikiTitle = 'The Waterloo Mathematics Review Internal Wiki';

##  $ScriptUrl is your preferred URL for accessing wiki pages
##  $PubDirUrl is the URL for the pub directory.
$ScriptUrl = 'http://mathreview.uwaterloo.ca/wiki/index.php';
$PubDirUrl = 'http://mathreview.uwaterloo.ca/wiki/pub';
...
$DefaultPasswords['admin'] = crypt('wmrwikiadmin');
$DefaultPasswords['attr'] = crypt('wmrwikiadmin');
$DefaultPasswords['edit'] = crypt('mathreview');
